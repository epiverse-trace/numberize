...
![setup R and install depdencies are slow](images/docker-speed-comp-5.png){.border width="600"}

:::
::: {.column}
![initialize containers is faster](images/docker-speed-comp-3.png){.border width="600"}
